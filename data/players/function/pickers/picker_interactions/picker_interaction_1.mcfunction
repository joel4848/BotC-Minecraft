execute if score @s Player matches -1 run playsound block.note_block.bass block @s ~ ~ ~ 1.0 0.75
execute if score @s Player matches -1 run tellraw @s {"color":"red","text":"You're already assigned to this seat!"}
