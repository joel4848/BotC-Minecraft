...
team leave @a[scores={Player=-16}]
team empty Nominated
team join Nominated @a[scores={Player=-16}]
scoreboard players set @a[scores={Player=-16}] Nominated 1
...
scoreboard players set #big_hand_target temp 16

scoreboard players set #nominated_player_big_hand temp 16
