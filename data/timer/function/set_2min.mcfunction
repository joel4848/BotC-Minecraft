...
bossbar set minecraft:timerbar max 2400
scoreboard players set TimerEntity TimerMax 2400
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 2400
scoreboard players set TimerEntity TimerMinutes 2
