execute store result bossbar minecraft:timerbar value run scoreboard players add TimerEntity TimerScore 2400
scoreboard players add TimerEntity TimerMinutes 2
