...
execute unless score #vote_testing temp matches 1 run schedule function voting:exile/process/vote_sequence 120t
execute if score #vote_testing temp matches 1 run schedule function voting:exile/process/vote_sequence 20t
# 120t
