...
execute as @e[tag=votelight] at @s if block ~ ~ ~ waxed_copper_bulb[lit=true] run setblock ~ ~ ~ waxed_copper_bulb[lit=false]
execute as @e[tag=votelight] at @s if block ~ ~ ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~ ~ waxed_oxidized_copper_bulb[lit=false]
