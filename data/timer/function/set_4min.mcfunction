...
bossbar set minecraft:timerbar max 4800
scoreboard players set TimerEntity TimerMax 4800
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 4800
scoreboard players set TimerEntity TimerMinutes 4
