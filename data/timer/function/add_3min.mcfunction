execute store result bossbar minecraft:timerbar value run scoreboard players add TimerEntity TimerScore 3600
scoreboard players add TimerEntity TimerMinutes 3
