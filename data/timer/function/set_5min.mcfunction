...
bossbar set minecraft:timerbar max 6000
scoreboard players set TimerEntity TimerMax 6000
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 6000
