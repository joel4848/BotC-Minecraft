...
execute unless score #voudon temp matches 1 run execute at @e[type=marker,tag=votelight4,limit=1,sort=nearest] run execute unless score #og_silence_votelights temp matches 1 run playsound minecraft:block.lever.click block @a ~ ~ ~ 1.0 1.0
execute as @e[type=marker,tag=votelight4,limit=1,sort=nearest] at @s if score #voudon temp matches 1 run execute if block ~ ~ ~ waxed_weathered_copper_bulb run execute unless score #og_silence_votelights temp matches 1 run playsound minecraft:block.lever.click block @a ~ ~ ~ 1.0 1.0