...
bossbar set minecraft:timerbar max 7200
scoreboard players set TimerEntity TimerMax 7200
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 7200
scoreboard players set TimerEntity TimerMinutes 6
