...
bossbar set minecraft:timerbar max 10800
scoreboard players set TimerEntity TimerMax 10800
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 10800
scoreboard players set TimerEntity TimerMinutes 9
