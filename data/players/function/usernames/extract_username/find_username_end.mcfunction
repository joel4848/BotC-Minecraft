...
function players:usernames/extract_username/get_char_at_pos with storage temp:parse
...
execute unless score is_quote temp matches 0 run function players:usernames/extract_username/find_username_end