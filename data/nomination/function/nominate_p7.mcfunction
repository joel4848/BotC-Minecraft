...
team leave @a[scores={Player=-7}]
team empty Nominated
team join Nominated @a[scores={Player=-7}]
scoreboard players set @a[scores={Player=-7}] Nominated 1
...
scoreboard players set #big_hand_target temp 7

scoreboard players set #nominated_player_big_hand temp 7
