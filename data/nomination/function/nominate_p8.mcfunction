...
team leave @a[scores={Player=-8}]
team empty Nominated
team join Nominated @a[scores={Player=-8}]
scoreboard players set @a[scores={Player=-8}] Nominated 1
effect give @a[scores={Player=-8}] glowing infinite 99 true
...
scoreboard players set #big_hand_target temp 8

scoreboard players set #nominated_player_big_hand temp 8

# scoreboard players set #big_hand_speed temp 200
