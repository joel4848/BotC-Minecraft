...
bossbar set minecraft:timerbar max 9600
scoreboard players set TimerEntity TimerMax 9600
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 9600
scoreboard players set TimerEntity TimerMinutes 8
