...
team leave @a[scores={Player=-15}]
team empty Nominated
team join Nominated @a[scores={Player=-15}]
scoreboard players set @a[scores={Player=-15}] Nominated 1
...
scoreboard players set #big_hand_target temp 15

scoreboard players set #nominated_player_big_hand temp 15
