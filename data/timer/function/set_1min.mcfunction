...
bossbar set minecraft:timerbar max 1200
scoreboard players set TimerEntity TimerMax 1200
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 1200
scoreboard players set TimerEntity TimerMinutes 1
