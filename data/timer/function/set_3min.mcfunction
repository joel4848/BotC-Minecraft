...
bossbar set minecraft:timerbar max 3600
scoreboard players set TimerEntity TimerMax 3600
execute store result bossbar minecraft:timerbar value run scoreboard players set TimerEntity TimerScore 3600
scoreboard players set TimerEntity TimerMinutes 3
