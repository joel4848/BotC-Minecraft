...
execute as @a[scores={Alive=1,Player=..0}] run execute if items entity @s armor.chest golden_chestplate run item replace entity @s armor.chest with minecraft:air
