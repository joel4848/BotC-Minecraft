...
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-1},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-1},limit=1] Alive matches 0 run execute as @e[tag=votelight1] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-2},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-2},limit=1] Alive matches 0 run execute as @e[tag=votelight2] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-3},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-3},limit=1] Alive matches 0 run execute as @e[tag=votelight3] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-4},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-4},limit=1] Alive matches 0 run execute as @e[tag=votelight4] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-5},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-5},limit=1] Alive matches 0 run execute as @e[tag=votelight5] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-6},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-6},limit=1] Alive matches 0 run execute as @e[tag=votelight6] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-7},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-7},limit=1] Alive matches 0 run execute as @e[tag=votelight7] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-8},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-8},limit=1] Alive matches 0 run execute as @e[tag=votelight8] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-9},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-9},limit=1] Alive matches 0 run execute as @e[tag=votelight9] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-10},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-10},limit=1] Alive matches 0 run execute as @e[tag=votelight10] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-11},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-11},limit=1] Alive matches 0 run execute as @e[tag=votelight11] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-12},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-12},limit=1] Alive matches 0 run execute as @e[tag=votelight12] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-13},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-13},limit=1] Alive matches 0 run execute as @e[tag=votelight13] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-14},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-14},limit=1] Alive matches 0 run execute as @e[tag=votelight14] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-15},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-15},limit=1] Alive matches 0 run execute as @e[tag=votelight15] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 1 run execute if score @a[scores={Player=-16},limit=1] IsBanshee matches 0 run execute if score @a[scores={Player=-16},limit=1] Alive matches 0 run execute as @e[tag=votelight16] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate


execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-1},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight1] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-2},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight2] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-3},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight3] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-4},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight4] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-5},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight5] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-6},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight6] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-7},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight7] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-8},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight8] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-9},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight9] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-10},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight10] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-11},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight11] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-12},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight12] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-13},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight13] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-14},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight14] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-15},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight15] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
execute if score #og_enabled temp matches 0 run execute if score @a[scores={Player=-16},limit=1] IsBanshee matches 0 run execute as @e[tag=votelight16] run execute at @s if block ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=true] run setblock ~ ~-1 ~ reinforced_deepslate
