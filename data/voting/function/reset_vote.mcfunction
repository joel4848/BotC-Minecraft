...
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight1] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight2] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight3] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight4] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight5] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight6] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight7] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight8] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight9] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight10] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight11] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight12] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight13] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight14] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight15] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]
execute unless score #voudon temp matches 1 run execute as @e[tag=votelight16] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_oxidized_copper_bulb[lit=false]

execute if score #voudon temp matches 1 run execute as @e[tag=votelight1] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight2] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight3] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight4] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight5] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight6] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight7] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight8] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight9] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight10] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight11] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight12] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight13] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight14] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight15] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute if score #voudon temp matches 1 run execute as @e[tag=votelight16] run execute at @s if block ~ ~-1 ~ pearlescent_froglight run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
...
# Reset used Voudon ghost vote lights to waxed weathered copper bulb if waxed_weathered_copper_bulb[lit=true]

execute as @e[tag=votelight1] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight2] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight3] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight4] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight5] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight6] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight7] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight8] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight9] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight10] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight11] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight12] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight13] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight14] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight15] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
execute as @e[tag=votelight16] run execute at @s if block ~ ~-1 ~ waxed_weathered_copper_bulb[lit=true] run setblock ~ ~-1 ~ waxed_weathered_copper_bulb[lit=false]
