# call with teleport:st_to_house {player:%d}

$execute if score #tp_disabled temp matches 0 run teleport @a[scores={Storyteller=1}] @e[limit=1,tag=house$(player),type=marker]
