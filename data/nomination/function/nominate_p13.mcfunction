...
team leave @a[scores={Player=-13}]
team empty Nominated
team join Nominated @a[scores={Player=-13}]
scoreboard players set @a[scores={Player=-13}] Nominated 1
effect give @a[scores={Player=-13}] glowing infinite 99 true
...
scoreboard players set #big_hand_target temp 13

scoreboard players set #nominated_player_big_hand temp 13
