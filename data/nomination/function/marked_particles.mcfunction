execute as @a[scores={Marked=1}] at @s run particle dust_color_transition{from_color:[0.639,0.000,0.000],scale:1,to_color:[1.000,0.000,0.000]} ~ ~5 ~ 0.1 1 0.1 1 2 normal
