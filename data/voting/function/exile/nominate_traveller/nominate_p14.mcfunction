...
team leave @a[scores={Player=-14}]
team empty Nominated
team join Nominated @a[scores={Player=-14}]
scoreboard players set @a[scores={Player=-14}] Nominated 1
effect give @a[scores={Player=-14}] glowing infinite 99 true
...
scoreboard players set #big_hand_target temp 14

scoreboard players set #nominated_player_big_hand temp 14
