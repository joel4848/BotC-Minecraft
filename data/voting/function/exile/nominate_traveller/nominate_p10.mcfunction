...
team leave @a[scores={Player=-10}]
team empty Nominated
team join Nominated @a[scores={Player=-10}]
scoreboard players set @a[scores={Player=-10}] Nominated 1
...
scoreboard players set #big_hand_target temp 10

scoreboard players set #nominated_player_big_hand temp 10
