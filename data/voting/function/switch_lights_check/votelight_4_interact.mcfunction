...
execute if score @s Player matches -4 run function voting:switch_lights/votelight_4_interact
execute unless score @s Player matches -4 if score @s Storyteller matches 1 run function voting:switch_lights/votelight_4_interact
