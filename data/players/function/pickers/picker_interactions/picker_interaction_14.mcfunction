...
execute at @s unless score @s Player matches -14 run playsound minecraft:entity.experience_orb.pickup block @a ~ ~ ~ 1.0 1.0

scoreboard players set @s HasSeat 1

function players:assign/assign {player:14}
