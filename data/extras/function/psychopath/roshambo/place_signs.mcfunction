...
setblock 184 99 2 dark_oak_wall_sign[facing=east]{front_text:{color:"white",has_glowing_text:1b,messages:['{"text":""}','{"text":"Click a sign"}','{"text":"to choose!"}','{"text":""}']}} replace

setblock 184 99 0 dark_oak_wall_sign[facing=east]{front_text:{color:"white",has_glowing_text:1b,messages:['{"text":""}','{"text":"Click here to lock"}','{"text":"in your choice!","clickEvent":{"action":"run_command","value":"/trigger ConfirmRoshamboLock set 1"}}','{"text":""}']}} replace
...
setblock 150 99 0 dark_oak_wall_sign[facing=west]{front_text:{color:"white",has_glowing_text:1b,messages:['{"text":""}','{"text":"Click a sign"}','{"text":"to choose!"}','{"text":""}']}} replace

setblock 150 99 2 dark_oak_wall_sign[facing=west]{front_text:{color:"white",has_glowing_text:1b,messages:['{"text":""}','{"text":"Click here to lock"}','{"text":"in your choice!","clickEvent":{"action":"run_command","value":"/trigger ConfirmRoshamboLock set 1"}}','{"text":""}']}} replace