...
team leave @a[scores={Player=-2}]
team empty Nominated
team join Nominated @a[scores={Player=-2}]
scoreboard players set @a[scores={Player=-2}] Nominated 1
effect give @a[scores={Player=-2}] glowing infinite 99 true
...
scoreboard players set #big_hand_target temp 2

scoreboard players set #nominated_player_big_hand temp 2
